...
- **pitchfork_reviews_sentiment.csv**: Fully analyzed dataset with all extracted features and sentiment results. Includes columns for sentiment, mood, instrumentation, production, novelty, context, and more, generated by `sentiment_analyzer.py`.
