...
if recommend_button or surprise_button or user_prompt:
    if user_prompt:
        ...
        with st.spinner("Finding albums..."):
            ...
            recommendations = st.session_state.recommender.recommend_diverse(user_prompt, top_n=20, min_score=7.0)
        ...
        st.info("Tell us what you're in the mood for and we'll find the perfect albums!")
